...
source: "https://onefly.top/zero2Agent/learn-agent-basic/13-context-engineering/index.html"
author:
published:
created: 2026-08-27
...
| --- | --- |
| 模型需要从长历史中推断已完成哪些步骤 | 直接读取 task\_plan 的 checkbox |
| 模型不知道还能调几次工具 | 直接看 tool\_calls\_remaining |
| 模型不知道当前时间 | 直接读 current\_time |
