...
source: "https://onefly.top/zero2Agent/learn-agent-basic/05-tool-calling-basics/index.html"
author:
published:
created: 2026-08-26
...
- 模型为什么不会自动记住上一次请求
- 一次请求由哪些部分组成
- `system` 、 `developer` 、 `user` 、 `assistant` 、 `tool` 分别表示什么
- 响应除了文本，还包含哪些控制信息
...
```
#mermaid-1787724058960{font-family:"Noto Sans SC","Inter",sans-serif;font-size:14px;fill:#333;}#mermaid-1787724058960 .error-icon{fill:#552222;}#mermaid-1787724058960 .error-text{fill:#552222;stroke:#552222;}#mermaid-1787724058960 .edge-thickness-normal{stroke-width:2px;}#mermaid-1787724058960 .edge-thickness-thick{stroke-width:3.5px;}#mermaid-1787724058960 .edge-pattern-solid{stroke-dasharray:0;}#mermaid-1787724058960 .edge-pattern-dashed{stroke-dasharray:3;}#mermaid-1787724058960 .edge-pattern-dotted{stroke-dasharray:2;}#mermaid-1787724058960 .marker{fill:#059669;stroke:#059669;}#mermaid-1787724058960 .marker.cross{stroke:#059669;}#mermaid-1787724058960 svg{font-family:"Noto Sans SC","Inter",sans-serif;font-size:14px;}#mermaid-1787724058960 .label{font-family:"Noto Sans SC","Inter",sans-serif;color:#333;}#mermaid-1787724058960 .cluster-label text{fill:#333;}#mermaid-1787724058960 .cluster-label span{color:#333;}#mermaid-1787724058960 .label text,#mermaid-1787724058960 span{fill:#333;color:#333;}#mermaid-1787724058960 .node rect,#mermaid-1787724058960 .node circle,#mermaid-1787724058960 .node ellipse,#mermaid-1787724058960 .node polygon,#mermaid-1787724058960 .node path{fill:#ECECFF;stroke:#9370DB;stroke-width:1px;}#mermaid-1787724058960 .node .label{text-align:center;}#mermaid-1787724058960 .node.clickable{cursor:pointer;}#mermaid-1787724058960 .arrowheadPath{fill:#333333;}#mermaid-1787724058960 .edgePath .path{stroke:#059669;stroke-width:2.0px;}#mermaid-1787724058960 .flowchart-link{stroke:#059669;fill:none;}#mermaid-1787724058960 .edgeLabel{background-color:#ffffff;text-align:center;}#mermaid-1787724058960 .edgeLabel rect{opacity:0.5;background-color:#ffffff;fill:#ffffff;}#mermaid-1787724058960 .cluster rect{fill:#f8fafc;stroke:#aaaa33;stroke-width:1px;}#mermaid-1787724058960 .cluster text{fill:#333;}#mermaid-1787724058960 .cluster span{color:#333;}#mermaid-1787724058960 div.mermaidTooltip{position:absolute;text-align:center;max-width:200px;padding:2px;font-family:"Noto Sans SC","Inter",sans-serif;font-size:12px;background:#ecfdf5;border:1px solid #aaaa33;border-radius:2px;pointer-events:none;z-index:100;}#mermaid-1787724058960 .flowchartTitleText{text-anchor:middle;font-size:18px;fill:#333;}#mermaid-1787724058960 :root{--mermaid-font-family:"trebuchet ms",verdana,arial,sans-serif;}决定做什么真的去做返回模型程序结果
```

更完整一点就是：

```
#mermaid-1787724059048{font-family:"Noto Sans SC","Inter",sans-serif;font-size:14px;fill:#333;}#mermaid-1787724059048 .error-icon{fill:#552222;}#mermaid-1787724059048 .error-text{fill:#552222;stroke:#552222;}#mermaid-1787724059048 .edge-thickness-normal{stroke-width:2px;}#mermaid-1787724059048 .edge-thickness-thick{stroke-width:3.5px;}#mermaid-1787724059048 .edge-pattern-solid{stroke-dasharray:0;}#mermaid-1787724059048 .edge-pattern-dashed{stroke-dasharray:3;}#mermaid-1787724059048 .edge-pattern-dotted{stroke-dasharray:2;}#mermaid-1787724059048 .marker{fill:#059669;stroke:#059669;}#mermaid-1787724059048 .marker.cross{stroke:#059669;}#mermaid-1787724059048 svg{font-family:"Noto Sans SC","Inter",sans-serif;font-size:14px;}#mermaid-1787724059048 .label{font-family:"Noto Sans SC","Inter",sans-serif;color:#333;}#mermaid-1787724059048 .cluster-label text{fill:#333;}#mermaid-1787724059048 .cluster-label span{color:#333;}#mermaid-1787724059048 .label text,#mermaid-1787724059048 span{fill:#333;color:#333;}#mermaid-1787724059048 .node rect,#mermaid-1787724059048 .node circle,#mermaid-1787724059048 .node ellipse,#mermaid-1787724059048 .node polygon,#mermaid-1787724059048 .node path{fill:#ECECFF;stroke:#9370DB;stroke-width:1px;}#mermaid-1787724059048 .node .label{text-align:center;}#mermaid-1787724059048 .node.clickable{cursor:pointer;}#mermaid-1787724059048 .arrowheadPath{fill:#333333;}#mermaid-1787724059048 .edgePath .path{stroke:#059669;stroke-width:2.0px;}#mermaid-1787724059048 .flowchart-link{stroke:#059669;fill:none;}#mermaid-1787724059048 .edgeLabel{background-color:#ffffff;text-align:center;}#mermaid-1787724059048 .edgeLabel rect{opacity:0.5;background-color:#ffffff;fill:#ffffff;}#mermaid-1787724059048 .cluster rect{fill:#f8fafc;stroke:#aaaa33;stroke-width:1px;}#mermaid-1787724059048 .cluster text{fill:#333;}#mermaid-1787724059048 .cluster span{color:#333;}#mermaid-1787724059048 div.mermaidTooltip{position:absolute;text-align:center;max-width:200px;padding:2px;font-family:"Noto Sans SC","Inter",sans-serif;font-size:12px;background:#ecfdf5;border:1px solid #aaaa33;border-radius:2px;pointer-events:none;z-index:100;}#mermaid-1787724059048 .flowchartTitleText{text-anchor:middle;font-size:18px;fill:#333;}#mermaid-1787724059048 :root{--mermaid-font-family:"trebuchet ms",verdana,arial,sans-serif;}否是用户目标模型判断是否需要工具模型选择工具并生成参数程序校验参数并执行工具程序把结果返回给模型信息是否足够模型生成最终答案
```
...
有的协议把这些 item 都表现成带 `role` 的 message；有的协议在一条 message 内使用多个 content block；还有的协议直接返回一组不同类型的 output item。字段形式不同，语义流转却基本相同。

### 角色不是跨厂商通用枚举

常见角色可以这样理解：

- `system` ：系统级规则。部分接口把它放在消息数组中，部分接口使用顶层字段。
- `developer` ：开发者指令。某些 OpenAI 接口或模型用它区分应用规则与普通用户输入；并非所有兼容接口都支持。
- `user` ：用户提供的目标和内容。
- `assistant` ：模型产生的文本、工具请求或其他输出。
- `tool` ：在部分 Chat Completions 风格协议中表示工具执行结果，不是模型自己生成的事实。

下表只用于建立语义映射，不用于代替官方字段文档：

| 语义 | Chat Completions 风格 | OpenAI Responses 风格 | Anthropic 风格 | Gemini 风格 |
| --- | --- | --- | --- | --- |
| 开发者规则 | `system` / 部分模型支持 `developer` | `instructions` 或输入 item | 顶层 `system` | `systemInstruction` |
| 用户输入 | `user` message | input message/item | `user` message | `user` content |
| 模型输出 | `assistant` message | output item | `assistant` content block | `model` content |
| 工具请求 | `assistant.tool_calls` | function call item | `tool_use` block | `functionCall` part |
| 工具结果 | `tool` + `tool_call_id` | function call output + `call_id` | `tool_result` block | `functionResponse` part |
...
只读取 `content` 是许多 Agent Bug 的起点。一次成功响应至少可能包含：
...
1. `content` 为空不代表响应失败，模型可能正在请求工具。
2. 在这种协议中， `arguments` 是一段 JSON 字符串，程序仍需解析并按 Schema 校验。
3. `finish_reason` 和 `usage` 的字段名、取值会因厂商而异，不能在跨厂商代码里直接写死。
...
这段错误应作为 `call_weather_01` 的工具结果返回，而不是伪装成普通用户消息。
...
- [Memory 设计模式](https://onefly.top/zero2Agent/learn-agent-basic/06-memory-patterns/index.html)