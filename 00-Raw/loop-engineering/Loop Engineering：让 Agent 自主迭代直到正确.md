...
source: "https://onefly.top/zero2Agent/learn-agent-basic/10-loop-engineering/index.html"
author:
published:
created: 2026-08-27
...
1. **行为指纹去重** ：记录每轮的 (action\_type, params\_hash)，连续 2 次相同指纹 → 强制切换策略或终止
...
- [Agent Infra：从 Harness 到生产环境](https://onefly.top/zero2Agent/learn-agent-basic/09-agent-infra/index.html) ——Loop 设计好之后，需要 Infra 支撑它在生产中稳定运行