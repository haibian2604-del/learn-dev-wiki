...
source: "https://onefly.top/zero2Agent/learn-agent-training/06-train-to-deploy/index.html"
author:
published:
created: 2026-08-27
...
```
#mermaid-1787842444966{font-family:"Noto Sans SC","Inter",sans-serif;font-size:14px;fill:#ccc;}#mermaid-1787842444966 .error-icon{fill:#a44141;}#mermaid-1787842444966 .error-text{fill:#ddd;stroke:#ddd;}#mermaid-1787842444966 .edge-thickness-normal{stroke-width:2px;}#mermaid-1787842444966 .edge-thickness-thick{stroke-width:3.5px;}#mermaid-1787842444966 .edge-pattern-solid{stroke-dasharray:0;}#mermaid-1787842444966 .edge-pattern-dashed{stroke-dasharray:3;}#mermaid-1787842444966 .edge-pattern-dotted{stroke-dasharray:2;}#mermaid-1787842444966 .marker{fill:#10b981;stroke:#10b981;}#mermaid-1787842444966 .marker.cross{stroke:#10b981;}#mermaid-1787842444966 svg{font-family:"Noto Sans SC","Inter",sans-serif;font-size:14px;}#mermaid-1787842444966 .label{font-family:"Noto Sans SC","Inter",sans-serif;color:#ccc;}#mermaid-1787842444966 .cluster-label text{fill:#F9FFFE;}#mermaid-1787842444966 .cluster-label span{color:#F9FFFE;}#mermaid-1787842444966 .label text,#mermaid-1787842444966 span{fill:#ccc;color:#ccc;}#mermaid-1787842444966 .node rect,#mermaid-1787842444966 .node circle,#mermaid-1787842444966 .node ellipse,#mermaid-1787842444966 .node polygon,#mermaid-1787842444966 .node path{fill:#1f2020;stroke:#81B1DB;stroke-width:1px;}#mermaid-1787842444966 .node .label{text-align:center;}#mermaid-1787842444966 .node.clickable{cursor:pointer;}#mermaid-1787842444966 .arrowheadPath{fill:lightgrey;}#mermaid-1787842444966 .edgePath .path{stroke:#10b981;stroke-width:2.0px;}#mermaid-1787842444966 .flowchart-link{stroke:#10b981;fill:none;}#mermaid-1787842444966 .edgeLabel{background-color:#0d0d12;text-align:center;}#mermaid-1787842444966 .edgeLabel rect{opacity:0.5;background-color:#0d0d12;fill:#0d0d12;}#mermaid-1787842444966 .cluster rect{fill:#13131f;stroke:rgba(255, 255, 255, 0.25);stroke-width:1px;}#mermaid-1787842444966 .cluster text{fill:#F9FFFE;}#mermaid-1787842444966 .cluster span{color:#F9FFFE;}#mermaid-1787842444966 div.mermaidTooltip{position:absolute;text-align:center;max-width:200px;padding:2px;font-family:"Noto Sans SC","Inter",sans-serif;font-size:12px;background:#161e2e;border:1px solid rgba(255, 255, 255, 0.25);border-radius:2px;pointer-events:none;z-index:100;}#mermaid-1787842444966 .flowchartTitleText{text-anchor:middle;font-size:18px;fill:#ccc;}#mermaid-1787842444966 :root{--mermaid-font-family:"trebuchet ms",verdana,arial,sans-serif;}训练完成得到 Checkpoint模型选择选哪个 Checkpoint模型压缩量化 / 蒸馏推理优化加速推理速度服务架构搭建 Agent Runtime工具层工具注册与编排安全层输入输出过滤灰度发布小流量验证全量上线+ 监控告警
```
...
- [Agent 训练环境工程：从仿真沙箱到数据回流闭环](https://onefly.top/zero2Agent/learn-agent-training/07-training-environment-engineering/index.html) ：补齐算法之外的沙箱、评估和数据回流工程