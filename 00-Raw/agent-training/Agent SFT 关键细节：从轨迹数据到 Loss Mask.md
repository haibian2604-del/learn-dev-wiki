...
source: "https://onefly.top/zero2Agent/learn-agent-training/01-agent-sft/index.html"
author:
published:
created: 2026-08-27
...
```
#mermaid-1787841900754{font-family:"Noto Sans SC","Inter",sans-serif;font-size:14px;fill:#ccc;}#mermaid-1787841900754 .error-icon{fill:#a44141;}#mermaid-1787841900754 .error-text{fill:#ddd;stroke:#ddd;}#mermaid-1787841900754 .edge-thickness-normal{stroke-width:2px;}#mermaid-1787841900754 .edge-thickness-thick{stroke-width:3.5px;}#mermaid-1787841900754 .edge-pattern-solid{stroke-dasharray:0;}#mermaid-1787841900754 .edge-pattern-dashed{stroke-dasharray:3;}#mermaid-1787841900754 .edge-pattern-dotted{stroke-dasharray:2;}#mermaid-1787841900754 .marker{fill:#10b981;stroke:#10b981;}#mermaid-1787841900754 .marker.cross{stroke:#10b981;}#mermaid-1787841900754 svg{font-family:"Noto Sans SC","Inter",sans-serif;font-size:14px;}#mermaid-1787841900754 .label{font-family:"Noto Sans SC","Inter",sans-serif;color:#ccc;}#mermaid-1787841900754 .cluster-label text{fill:#F9FFFE;}#mermaid-1787841900754 .cluster-label span{color:#F9FFFE;}#mermaid-1787841900754 .label text,#mermaid-1787841900754 span{fill:#ccc;color:#ccc;}#mermaid-1787841900754 .node rect,#mermaid-1787841900754 .node circle,#mermaid-1787841900754 .node ellipse,#mermaid-1787841900754 .node polygon,#mermaid-1787841900754 .node path{fill:#1f2020;stroke:#81B1DB;stroke-width:1px;}#mermaid-1787841900754 .node .label{text-align:center;}#mermaid-1787841900754 .node.clickable{cursor:pointer;}#mermaid-1787841900754 .arrowheadPath{fill:lightgrey;}#mermaid-1787841900754 .edgePath .path{stroke:#10b981;stroke-width:2.0px;}#mermaid-1787841900754 .flowchart-link{stroke:#10b981;fill:none;}#mermaid-1787841900754 .edgeLabel{background-color:#0d0d12;text-align:center;}#mermaid-1787841900754 .edgeLabel rect{opacity:0.5;background-color:#0d0d12;fill:#0d0d12;}#mermaid-1787841900754 .cluster rect{fill:#13131f;stroke:rgba(255, 255, 255, 0.25);stroke-width:1px;}#mermaid-1787841900754 .cluster text{fill:#F9FFFE;}#mermaid-1787841900754 .cluster span{color:#F9FFFE;}#mermaid-1787841900754 div.mermaidTooltip{position:absolute;text-align:center;max-width:200px;padding:2px;font-family:"Noto Sans SC","Inter",sans-serif;font-size:12px;background:#161e2e;border:1px solid rgba(255, 255, 255, 0.25);border-radius:2px;pointer-events:none;z-index:100;}#mermaid-1787841900754 .flowchartTitleText{text-anchor:middle;font-size:18px;fill:#ccc;}#mermaid-1787841900754 :root{--mermaid-font-family:"trebuchet ms",verdana,arial,sans-serif;}🔧 System Prompt你是一个天气助手，可以调用 get_weather 工具👤 User帮我查一下北京明天的天气如果下雨就提醒我带伞💭 Think需要先调天气 API查询北京明天的天气...⚡ Tool Callget_weather&amp;(city=北京, date=tomorrow&amp;)📦 Tool Return&amp;{weather: 小雨, temp: 12-18°C&amp;}💭 Think结果显示明天有小雨需要提醒用户带伞...✅ Response北京明天小雨，12-18°C建议带伞出门
```
...
- Loss Mask 是 Agent SFT 的核心技巧：只对 tool\_call 和最终回复算 loss，屏蔽 system prompt、user 消息和 tool 返回
- 训练数据不能只放 Agent 轨迹，需要混入通用指令、安全数据等，防止能力崩塌
- SFT 和 RL 是两个阶段：SFT 让模型“能跑”，RL 让模型“跑得好”；SFT 不要刷太高完成率，给 RL 留探索空间

下一篇建议继续看：

- [Agent RL 实战：用强化学习提升推理与决策质量](https://onefly.top/zero2Agent/learn-agent-training/02-agent-rl/index.html)