...
source: "https://onefly.top/zero2Agent/learn-agent-training/02-agent-rl/index.html"
author:
published:
created: 2026-08-27
...
```
#mermaid-1787842001325{font-family:"Noto Sans SC","Inter",sans-serif;font-size:14px;fill:#ccc;}#mermaid-1787842001325 .error-icon{fill:#a44141;}#mermaid-1787842001325 .error-text{fill:#ddd;stroke:#ddd;}#mermaid-1787842001325 .edge-thickness-normal{stroke-width:2px;}#mermaid-1787842001325 .edge-thickness-thick{stroke-width:3.5px;}#mermaid-1787842001325 .edge-pattern-solid{stroke-dasharray:0;}#mermaid-1787842001325 .edge-pattern-dashed{stroke-dasharray:3;}#mermaid-1787842001325 .edge-pattern-dotted{stroke-dasharray:2;}#mermaid-1787842001325 .marker{fill:#10b981;stroke:#10b981;}#mermaid-1787842001325 .marker.cross{stroke:#10b981;}#mermaid-1787842001325 svg{font-family:"Noto Sans SC","Inter",sans-serif;font-size:14px;}#mermaid-1787842001325 .label{font-family:"Noto Sans SC","Inter",sans-serif;color:#ccc;}#mermaid-1787842001325 .cluster-label text{fill:#F9FFFE;}#mermaid-1787842001325 .cluster-label span{color:#F9FFFE;}#mermaid-1787842001325 .label text,#mermaid-1787842001325 span{fill:#ccc;color:#ccc;}#mermaid-1787842001325 .node rect,#mermaid-1787842001325 .node circle,#mermaid-1787842001325 .node ellipse,#mermaid-1787842001325 .node polygon,#mermaid-1787842001325 .node path{fill:#1f2020;stroke:#81B1DB;stroke-width:1px;}#mermaid-1787842001325 .node .label{text-align:center;}#mermaid-1787842001325 .node.clickable{cursor:pointer;}#mermaid-1787842001325 .arrowheadPath{fill:lightgrey;}#mermaid-1787842001325 .edgePath .path{stroke:#10b981;stroke-width:2.0px;}#mermaid-1787842001325 .flowchart-link{stroke:#10b981;fill:none;}#mermaid-1787842001325 .edgeLabel{background-color:#0d0d12;text-align:center;}#mermaid-1787842001325 .edgeLabel rect{opacity:0.5;background-color:#0d0d12;fill:#0d0d12;}#mermaid-1787842001325 .cluster rect{fill:#13131f;stroke:rgba(255, 255, 255, 0.25);stroke-width:1px;}#mermaid-1787842001325 .cluster text{fill:#F9FFFE;}#mermaid-1787842001325 .cluster span{color:#F9FFFE;}#mermaid-1787842001325 div.mermaidTooltip{position:absolute;text-align:center;max-width:200px;padding:2px;font-family:"Noto Sans SC","Inter",sans-serif;font-size:12px;background:#161e2e;border:1px solid rgba(255, 255, 255, 0.25);border-radius:2px;pointer-events:none;z-index:100;}#mermaid-1787842001325 .flowchartTitleText{text-anchor:middle;font-size:18px;fill:#ccc;}#mermaid-1787842001325 :root{--mermaid-font-family:"trebuchet ms",verdana,arial,sans-serif;}动作：生成 tool_call或文本回复观测：tool 返回结果+ 对话历史Reward：任务完成？步数多少？质量如何？更新策略Agent(Policy Model)Environment(工具/API/沙箱)Reward Signal
```
...
- [GRPO vs PPO：Agent 强化学习算法深度对比与选型](https://onefly.top/zero2Agent/learn-agent-training/03-grpo-vs-ppo/index.html)