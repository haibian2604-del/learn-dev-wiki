...
source: "https://onefly.top/zero2Agent/learn-agent-training/07-training-environment-engineering/index.html"
author:
published:
created: 2026-08-27
...
![Agent 训练环境工程闭环](https://onefly.top/zero2Agent/learn-agent-training/07-training-environment-engineering/training-environment-loop.drawio.png)

[下载可编辑的 draw.io 源文件](https://onefly.top/zero2Agent/learn-agent-training/07-training-environment-engineering/training-environment-loop.drawio)
...
[训练数据配比](https://onefly.top/zero2Agent/learn-agent-training/04-data-mix/index.html) 解决的是一个数据集内部不同类型样本怎么混合；环境工程还要解决更上游的问题：下一批 episode 应该从哪里来。
...
- [Agent 应用实战](https://onefly.top/zero2Agent/learn-agent-practice/index.html) ：把训练、评估和运行时能力落到真实开发工作流中